        ...
        <div class="flex justify-between h-10">
            @if((Auth::user()->privilege == 4))
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('dashboard') }}" class="{{ Route::is('dashboard') ? 'hidden' : 'block' }}">
                           <img src="{{asset('images/ICONS/home.png')}}" width="30">
                    </x-nav-link>
                </div>
                <!-- <img src="{{asset('images/SIGDOL/Sistema de gestión.png')}}" > -->
                <label class="display-6 text-center" style="color: #0047bb;">{{ __('Portal web para la Asistencia de Inventario Técnologico') }}</label>
                    ...
                    <x-dropdown>
                        <x-slot name="trigger">   
                            <span class="inline-flex ">
                                <button type="button" style="margin-top: 5%;"class="inline-flex items-center px-3 py-2  text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                        {{ __('Registro') }}
